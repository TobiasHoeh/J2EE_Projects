...
define("jqplot", [
	'order!jquery',
    'order!libs/jqPlot/jquery.jqplot.min',
    'order!libs/jqPlot/plugins/jqplot.highlighter.min',
    'order!libs/jqPlot/plugins/jqplot.cursor.min',
    'order!libs/jqPlot/plugins/jqplot.dateAxisRenderer.min'], function(){
    return $.jqplot;
});
