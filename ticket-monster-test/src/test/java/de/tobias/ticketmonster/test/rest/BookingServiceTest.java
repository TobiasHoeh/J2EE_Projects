...
public class BookingServiceTest {
	...
	// }
	//
	// private BookingRequest createBookingRequest(Long showId, int
	// performanceNo, int... ticketPriceNos) {
	...
	// StringBuilder().append(t.getSeat().getSection()).append(" @ ").append(t.getPrice()).append(" (")
